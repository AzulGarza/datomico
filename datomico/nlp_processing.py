...
class LabelMyTextWidget:
    ...
    def __init__(self, df_source, content_column, class_list, class_id, output_column, unclassified_value=-1, randomize=False):
        ...
        self.items.append(ButtonLabeling(class_id = unclassified_value, description='Omitir', button_style='warning'))
        ...
        button_box = HBox([widgets.Label(value="Etiqueta"), *self.items])
